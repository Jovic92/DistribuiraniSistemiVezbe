 ...
 * 2017-03-09T20:18:44.998+01:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "rasporedcasova", 
                  wsdlLocation = "http://localhost:8080/03RasporedSOAP/RasporedPortType?WSDL",
...
public class Rasporedcasova extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/03RasporedSOAP/RasporedPortType?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Rasporedcasova.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/03RasporedSOAP/RasporedPortType?WSDL");
        }
        WSDL_LOCATION = url;
    }
